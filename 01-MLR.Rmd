...
**For model M4, show how to calculate each of the following quantities that appear in the model summary output, using the information given.**     
...
**For model M5, show how to calculate each of the following quantities that appear in the model summary output, using the information given.**    
