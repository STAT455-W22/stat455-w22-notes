...
4. Calculate and interpret standard errors, t-statistics, residual standard error, $R^2$, and F-statistics in a LLSR model's R output.          

5. Analyze data using linear least squares regression in R.           
...
$SE(b_0)$ represents the variability in expected winning speed for races run in 1896, between different samples of 122 races.   
...
$SE(b_1)$ represents the variability in rate of change in winning speed per year, between different samples of 122 races.    

**Hypothesis Test for Intercept Line**

**Null Hypothesis:** The average winning speed among all races similar to the Kentucky Derby, run in 1896 is 0. ($\beta_0=0$).   

**Alternative Hypothesis:** The average winning speed among all races similar to the Kentucky Derby, run in 1896 is not 0. ($\beta_0 \neq 0$).  
...
**Null Hypothesis:** There is no relationship between year and average winning speed, i.e., average winning speed does not change over time. ($\beta_1=0$).   

**Alternative Hypothesis:** There is a relationship between year and average winning speed, i.e., average winning speed does change over time. ($\beta_1 \neq 0$).  
