...
Consider a longitudinal study involving four observations on the same units, taken over four consecutive weeks. Let $Y_{ij}$ represent the measurement on observational unit $i$ at time point $j$. Shown below are 3 different correlation matrices 

$\text{Corr}(Y_{i0},Y_{i1},Y_{i2},Y_{i3})$ between observations in weeks 0, 1, 2, and 3. For each matrix (A)-(D), sketch graphs showing the relationship between the indicated variables, on the grids below.  (10 points)
