...
a) Notice that the estimate associated with `program` is a very small and the associated p-value is very large. Explain why it would be incorrect to conclude from these values that the program has little effect on running pace. In your answer, explain specifically what this estimate tells us, and why it is not a good measure the effectiveness of the program.  
