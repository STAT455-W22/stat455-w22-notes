...
R output for Model M1 is shown below.   
...
In Scenario 1, explain why it is inappropriate to think of our sample size as being 96 plants in this scenario. What are the appropriate observational units, and what is the effective sample size for determining the effects of brand and amount?    

**b)** 

In Scenario 2, what is the effective sample size associated with brand variable? What about the amount variable?     
...
\[
Y_{ij}  = \beta_{0} + \beta_1\text{Brand}_{ij} + t_{i} + \epsilon_{ij},
\]
